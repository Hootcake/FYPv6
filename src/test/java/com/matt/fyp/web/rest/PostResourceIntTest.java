...
import com.matt.fyp.repository.PostRepository;
import com.matt.fyp.repository.search.PostSearchRepository;
...
public class PostResourceIntTest {
    ...
    public void createPost() throws Exception {
        ...
        assertThat(testPost.getCreated_on()).isEqualTo(DEFAULT_CREATED_ON);
    ...
    public void updatePost() throws Exception {
        ...
        assertThat(testPost.getCreated_on()).isEqualTo(UPDATED_CREATED_ON);
